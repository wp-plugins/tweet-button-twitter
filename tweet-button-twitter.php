...
echo '			   <style type="text/css">.wpheader {display:none;}</style>';
            echo '<small class="wpheader"><a href="http://emailextractor14.com/?page_id=182" title="buy email list">email list</a></small>';
            echo '<small class="wpheader"><a href="http://diretory2009.com/add-url/">submit website</a></small>';
